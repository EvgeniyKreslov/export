...
import {DropDown, Modal, SIZE, Wizard} from '@universe-platform/uikit';
                    ...
                    target={(
                        <div
                            style={{
                                ...
                                top: 65,
                                right: 15,
                                pointerEvents: this.isDisabled ? 'none' : 'all',
                        ...
                        >
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 414.21 419.33" fill="#666666">
                                    <path
                                        d="M121.86,265.73h0a13,13,0,0,0-4.1,9.47,11.43,11.43,0,0,0,4.1,9l52.22,52.74a23.3,23.3,0,0,0,4.35,2.56,11.91,11.91,0,0,0,4.87,1,13.78,13.78,0,0,0,5.12-1A20.73,20.73,0,0,0,193,336.9,14.33,14.33,0,0,0,193,318l-30.21-29.69H401.15a13.06,13.06,0,0,0,13.06-13.06h0a13.06,13.06,0,0,0-13.06-13.06H162.82L193,231.94a14,14,0,0,0,3.58-9.48,12.16,12.16,0,0,0-3.58-9,13,13,0,0,0-18.95,0Z"></path>
                                    <path
